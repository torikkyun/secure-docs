    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Nhập 12 từ mnemonic của bạn để khôi phục cặp khóa mã hóa. Hành động
            này sẽ ghi đè khóa hiện tại trong trình duyệt.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground">
              Passcode này dùng để mã hóa khóa riêng tư của bạn trên thiết bị
              này.
            </p>
          </div>
        </div>
